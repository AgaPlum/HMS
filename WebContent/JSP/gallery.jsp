...
<div id="d3">
<form id="galery" action="<%=request.getContextPath()%>/GalleryControl" method="get">
<img id="i1" src="<%=request.getContextPath()%>/IMG/room.jpg" alt="hall">
<input id="arrow-left" type="button" name="button1" >
<input id="arrow-right" type="button" name="button2" >
</form>
</div>
